#!/bin/bash
# First script run on train/test data. DO NOT RUN IF YOU ALREADY HAVE FOLDERS!
# Accepts the directory of Vott output as the first argument.
# COPY THIS SCRIPT TO THE VOTT OUTPUT FOLDER BEFORE RUNNING!!!
