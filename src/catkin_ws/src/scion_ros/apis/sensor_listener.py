    ...
    with socket.socket(socket.AF_INET, socket.SOCK_STREAM) as s:
        ...
        while True:
            ...
            if result == b'1':
                ...
                linker.data[4] = 0#dw_dvl.dvl_x
                linker.data[5] = 0#dw_dvl.dvl_y
                linker.data[6] = 0#dw_dvl.dvl_z
                linker.data[7] = 0#dw_dvl.dvl_mean
                linker.data[8] = 0#dw_dvl_time.dvl_time
                # Pickle and send
