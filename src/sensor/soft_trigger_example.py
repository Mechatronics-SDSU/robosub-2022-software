...
if __name__ == "__main__":
    PORT = input("Please enter your port number (e.g. '1' for /dev/ttyUSB1) =  ")
        ...
        if DVL.connect(PORT):
            ...
            if not DVL.get_setup():
                ...
                if not DVL.set_setup(SETUP):
                    ...
                    if not DVL.start_logging("/home/tristan/Develop/robosub-2022-software/src/sensor/dvl_driver/Wayfinder"
			, "DVL"):
