...
# source: socket_route_guide.proto
...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='socket_route_guide.proto',
  package='',
  syntax='proto3',
  serialized_options=None,
  create_key=_descriptor._internal_create_key,
  serialized_pb=b'\n\x18socket_route_guide.proto\"\x19\n\nMsgRequest\x12\x0b\n\x03req\x18\x01 \x01(\t\"\x17\n\x08MsgReply\x12\x0b\n\x03\x61\x63k\x18\x01 \x01(\t2;\n\nSocketGRPC\x12-\n\x11SendSocketRequest\x12\x0b.MsgRequest\x1a\t.MsgReply\"\x00\x62\x06proto3'
)
...
MsgRequest = _reflection.GeneratedProtocolMessageType('MsgRequest', (_message.Message,), {
  ...
  '__module__' : 'socket_route_guide_pb2'
...
_SOCKETGRPC = _descriptor.ServiceDescriptor(
  name='SocketGRPC',
  full_name='SocketGRPC',
  file=DESCRIPTOR,
  index=0,
  serialized_options=None,
  create_key=_descriptor._internal_create_key,
  ...
  _descriptor.MethodDescriptor(
    ...
    full_name='SocketGRPC.SendSocketRequest',
    index=0,
...
_sym_db.RegisterServiceDescriptor(_SOCKETGRPC)

DESCRIPTOR.services_by_name['SocketGRPC'] = _SOCKETGRPC
